...
const SCENARIOS = [
  ...
  { name: 'impl-visual 待登记队列 + evidence 静态核对 + exempt 生效/失效（warning，PASS）', dir: 'fixture-impl-visual-pending', args: [], expectExit: 0, golden: 'golden-run-checks-implvisual-pending.txt' },
  ...
  { name: 'impl-visual command 引用文件不存在挂 warning（PASS）', dir: 'fixture-impl-visual-gonefile', args: [], expectExit: 0, golden: 'golden-run-checks-implvisual-gonefile.txt' },
  ...
  { name: 'impl-visual 引号包裹的缺失文件仍挂 warning（PASS）', dir: 'fixture-impl-visual-quotedgone', args: [], expectExit: 0, golden: 'golden-run-checks-implvisual-quotedgone.txt' },
