...
#
# ★ 给落位执行者（读到本文件请执行）：
#   1. 下面用 ⟦FILE 路径⟧ … ⟦/FILE⟧ 包了 36 个文件（含版本 pin）。把每段内容【原样、逐字】写到它的「路径」（含子目录）。
...
#   12. design-spec-kit/docs/FLUTTER-VISUAL-EXTENSION-PROPOSAL.md
#   13. design-spec-kit/docs/IMPL-PROFILE.template.md
#   14. design-spec-kit/docs/SCREEN-MANIFEST.template.md
#   15. design-spec-kit/docs/SHELL-KIT.md
#   16. design-spec-kit/docs/VERSIONING.md
#   17. design-spec-kit/docs/config.template.json
#   18. design-spec-kit/docs/screen-manifest.schema.json
#   19. design-spec-kit/extensions/flutter-visual/README.md
#   20. design-spec-kit/extensions/flutter-visual/check-flutter-visual.js
#   21. design-spec-kit/extensions/flutter-visual/helpers/flutter_visual_contract.dart
#   22. design-spec-kit/package.json
#   23. design-spec-kit/tools/build-bundle.js
#   24. design-spec-kit/tools/check-changelog.js
#   25. design-spec-kit/tools/check-deviation.js
#   26. design-spec-kit/tools/check-i18n.js
#   27. design-spec-kit/tools/check-icons.js
#   28. design-spec-kit/tools/check-manifest.js
#   29. design-spec-kit/tools/check-orphan-css.js
#   30. design-spec-kit/tools/check-tokens.js
#   31. design-spec-kit/tools/ci-check.js
#   32. design-spec-kit/tools/install-git-hooks.js
#   33. design-spec-kit/tools/kit-doctor.js
#   34. design-spec-kit/tools/kit-registry.js
#   35. design-spec-kit/tools/run-checks.js
#   36. .design-spec-kit.version
#
# ════════════════════════════════════════════════════════════
...
- extension 目录缺失时给 setup guidance，不把所有复制式接入项目打红；未知名字视为拼写错误，由 `kit-doctor` FAIL，`run-checks --strict` FAIL。
...
⟦FILE design-spec-kit/docs/config.template.json⟧
{
  ...
  "kit": {
    ...
    "notes": "业务仓在这里配置已启用层 / extension；submodule 内源码保持只读。可选层：i18n、handoff。可选 extension：flutter-visual。"
  },
  "extensions": {
    "flutter-visual": {
      "screens": []
...
⟦FILE design-spec-kit/docs/screen-manifest.schema.json⟧
{
  ...
  "definitions": {
    "interaction": {
      ...
      "additionalProperties": false,
      "properties": {
        "trigger": { "type": "string", "pattern": "^[a-z][a-z0-9-]*$" },
        "action": { "enum": ["opens", "closes", "toggles", "selects", "navigates"] },
    ...
    "contracts": {
      ...
      "additionalProperties": false,
      "properties": {
        "surface": { "enum": ["dark-glass", "light-surface", "neutral-surface", "transparent", "danger-surface"] },
        "themeInvariant": { "type": "boolean" },
        "motion": {
          "type": "object",
          "additionalProperties": false,
          "properties": {
            "portrait": { "enum": ["none", "fade", "slide-up", "slide-down", "slide-in-left", "slide-in-right", "scale"] },
            "landscape": { "enum": ["none", "fade", "slide-up", "slide-down", "slide-in-left", "slide-in-right", "scale"] }
          }
        }
      }
    },
...
⟦FILE design-spec-kit/extensions/flutter-visual/helpers/flutter_visual_contract.dart⟧
import 'dart:ui';
