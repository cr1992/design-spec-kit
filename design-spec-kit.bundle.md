...
#
# ★ 给落位执行者（读到本文件请执行）：
#   1. 下面用 ⟦FILE 路径⟧ … ⟦/FILE⟧ 包了 37 个文件（含版本 pin）。把每段内容【原样、逐字】写到它的「路径」（含子目录）。
...
#   22. design-spec-kit/extensions/flutter-visual/helpers/flutter_visual_contract.dart
#   23. design-spec-kit/package.json
#   24. design-spec-kit/tools/build-bundle.js
#   25. design-spec-kit/tools/check-changelog.js
#   26. design-spec-kit/tools/check-deviation.js
#   27. design-spec-kit/tools/check-i18n.js
#   28. design-spec-kit/tools/check-icons.js
#   29. design-spec-kit/tools/check-manifest.js
#   30. design-spec-kit/tools/check-orphan-css.js
#   31. design-spec-kit/tools/check-tokens.js
#   32. design-spec-kit/tools/ci-check.js
#   33. design-spec-kit/tools/install-git-hooks.js
#   34. design-spec-kit/tools/kit-doctor.js
#   35. design-spec-kit/tools/kit-registry.js
#   36. design-spec-kit/tools/run-checks.js
#   37. .design-spec-kit.version
#
# ════════════════════════════════════════════════════════════
