...
#
# ★ 给落位执行者（读到本文件请执行）：
#   1. 下面用 ⟦FILE 路径⟧ … ⟦/FILE⟧ 包了 32 个文件（含版本 pin）。把每段内容【原样、逐字】写到它的「路径」（含子目录）。
...
#   19. design-spec-kit/package.json
#   20. design-spec-kit/tools/build-bundle.js
#   21. design-spec-kit/tools/check-changelog.js
#   22. design-spec-kit/tools/check-deviation.js
#   23. design-spec-kit/tools/check-i18n.js
#   24. design-spec-kit/tools/check-icons.js
#   25. design-spec-kit/tools/check-manifest.js
#   26. design-spec-kit/tools/check-orphan-css.js
#   27. design-spec-kit/tools/check-tokens.js
#   28. design-spec-kit/tools/ci-check.js
#   29. design-spec-kit/tools/install-git-hooks.js
#   30. design-spec-kit/tools/kit-doctor.js
#   31. design-spec-kit/tools/run-checks.js
#   32. .design-spec-kit.version
#
# ════════════════════════════════════════════════════════════
...
> 状态：方案草案，尚未实现。本文记录 `design-spec-kit` 的 Flutter 专用实现栈扩展设计。kit core 继续保持语言无关。
