# design-spec-kit · 单文件分发包（One-File Bundle）· v2.0.0
#
# 用途：当目标项目只能「一个个上传文件」、没有 git 时，只上传/粘贴本文件这一个即可。
#
# ★ 给接手项目的 AI（读到本文件请执行）：
#   1. 下面用 ⟦FILE 路径⟧ … ⟦/FILE⟧ 包了 25 个文件（含版本 pin）。把每段内容【原样、逐字】写到它的「路径」（含子目录）。
...
#
# 文件清单：
#   1. design-spec-kit/AI-BOOTSTRAP.md
#   2. design-spec-kit/CLAUDE.template.md
#   3. design-spec-kit/EXTENDING.md
#   4. design-spec-kit/HANDOFF.md
#   5. design-spec-kit/README.md
#   6. design-spec-kit/docs/CHANGELOG.template.md
#   7. design-spec-kit/docs/DESIGN-RATIONALE.md
#   8. design-spec-kit/docs/DESIGN-REF.template.md
#   9. design-spec-kit/docs/DEVIATION-LEDGER.template.md
#   10. design-spec-kit/docs/IMPL-PROFILE.template.md
#   11. design-spec-kit/docs/SCREEN-MANIFEST.template.md
#   12. design-spec-kit/docs/VERSIONING.md
#   13. design-spec-kit/docs/screen-manifest.schema.json
#   14. design-spec-kit/package.json
#   15. design-spec-kit/tools/build-bundle.js
#   16. design-spec-kit/tools/check-changelog.js
#   17. design-spec-kit/tools/check-deviation.js
#   18. design-spec-kit/tools/check-i18n.js
#   19. design-spec-kit/tools/check-icons.js
#   20. design-spec-kit/tools/check-manifest.js
#   21. design-spec-kit/tools/check-orphan-css.js
#   22. design-spec-kit/tools/check-tokens.js
#   23. design-spec-kit/tools/kit-doctor.js
#   24. design-spec-kit/tools/run-checks.js
#   25. .design-spec-kit.version
#
# ════════════════════════════════════════════════════════════
...
⟦FILE design-spec-kit/package.json⟧
{
  ...
  "private": true,
  "type": "module",
  "description": "设计纪律 + 还原交接套件（与平台无关）。guard 双环境：node 直接跑，或整段粘进无 shell 的 AI 沙箱。",
  "scripts": {
