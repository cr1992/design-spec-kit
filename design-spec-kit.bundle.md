# design-spec-kit · 单文件分发包（One-File Bundle）· v2.0.1
#
# 用途：当目标项目只能「一个个上传文件」、没有 git 时，只上传/粘贴本文件这一个即可。
#
# ★ 给落位执行者（读到本文件请执行）：
#   1. 下面用 ⟦FILE 路径⟧ … ⟦/FILE⟧ 包了 26 个文件（含版本 pin）。把每段内容【原样、逐字】写到它的「路径」（含子目录）。
...
#   13. design-spec-kit/docs/config.template.json
#   14. design-spec-kit/docs/screen-manifest.schema.json
#   15. design-spec-kit/package.json
#   16. design-spec-kit/tools/build-bundle.js
#   17. design-spec-kit/tools/check-changelog.js
#   18. design-spec-kit/tools/check-deviation.js
#   19. design-spec-kit/tools/check-i18n.js
#   20. design-spec-kit/tools/check-icons.js
#   21. design-spec-kit/tools/check-manifest.js
#   22. design-spec-kit/tools/check-orphan-css.js
#   23. design-spec-kit/tools/check-tokens.js
#   24. design-spec-kit/tools/kit-doctor.js
#   25. design-spec-kit/tools/run-checks.js
#   26. .design-spec-kit.version
#
# ════════════════════════════════════════════════════════════
