...
#
# ★ 给落位执行者（读到本文件请执行）：
#   1. 下面用 ⟦FILE 路径⟧ … ⟦/FILE⟧ 包了 39 个文件（含版本 pin）。把每段内容【原样、逐字】写到它的「路径」（含子目录）。
...
#   14. design-spec-kit/docs/MULTI-MODULE-PROPOSAL.md
#   15. design-spec-kit/docs/SCREEN-MANIFEST.template.md
#   16. design-spec-kit/docs/SHELL-KIT.md
#   17. design-spec-kit/docs/VERSIONING.md
#   18. design-spec-kit/docs/config.template.json
#   19. design-spec-kit/docs/screen-manifest.schema.json
#   20. design-spec-kit/extensions/flutter-visual/README.md
#   21. design-spec-kit/extensions/flutter-visual/check-flutter-visual.js
#   22. design-spec-kit/extensions/impl-visual/README.md
#   23. design-spec-kit/extensions/impl-visual/check-impl-visual.js
#   24. design-spec-kit/extensions/impl-visual/helpers/flutter/flutter_visual_contract.dart
#   25. design-spec-kit/package.json
#   26. design-spec-kit/tools/build-bundle.js
#   27. design-spec-kit/tools/check-changelog.js
#   28. design-spec-kit/tools/check-deviation.js
#   29. design-spec-kit/tools/check-i18n.js
#   30. design-spec-kit/tools/check-icons.js
#   31. design-spec-kit/tools/check-manifest.js
#   32. design-spec-kit/tools/check-orphan-css.js
#   33. design-spec-kit/tools/check-tokens.js
#   34. design-spec-kit/tools/ci-check.js
#   35. design-spec-kit/tools/install-git-hooks.js
#   36. design-spec-kit/tools/kit-doctor.js
#   37. design-spec-kit/tools/kit-registry.js
#   38. design-spec-kit/tools/run-checks.js
#   39. .design-spec-kit.version
#
# ════════════════════════════════════════════════════════════
